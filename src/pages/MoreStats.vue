...
export default {
	...
	created () {
		// Check whether any `card` object includes the `keywords` key (even if it's set to no value). Card objects generated by older versions of the app are missing the `keywords` as well as `power` and `toughness` keys, and thus their relevant stats tables won't be able to work properly.
