<template>
	<article class="contact-page solo-message">
		...
		<p>You can email Damian Schmidt, the developer of this web app, at <a href="mailto:damian@iristormdesign.com">damian@iristormdesign.com</a>. Any questions or comments are appreciated.</p>
