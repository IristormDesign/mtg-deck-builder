<template functional>
	<section id="add-multiple" key="add-multiple">
		...
		<section id="card-list-entry">
			...
			<p>In either of those cases, you could build the deck with the <a href="#list-editor">List Editor</a>’s <a href="#card-adder">card adder tool</a>, inserting each of the card names into the deck one by one. However, a faster way is to instead submit a list of card names together. To do that, first click the <a href="#add-multiple">“Add multiple” button</a> in the List Editor, which takes you to the Card List Entry page.</p>
			...
			<p>You could also use this submission form to edit the quantities of any card names that already exist in your deck’s main card group. Setting a name’s quantity to 0 will remove that name from the main group.</p>
