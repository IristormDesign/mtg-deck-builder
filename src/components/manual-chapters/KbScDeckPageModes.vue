<template functional>
	<section id="m-kbsc-deck-page-modes" key="kbsc-deck-page-modes">
		<h4>Keyboard Shortcuts: Deck Page Modes</h4>
		<p>While you’re on a <a href="#m-deck-pages">deck page</a>, you can switch between the <a href="#m-deck-page-modes">deck page modes</a> by pressing one of the following keys:</p>
		<ul class="keyboard-shortcuts">
			<li><kbd>1</kbd>: Set to the <a href="#m-deck-editor">Deck Editor</a>.</li>
