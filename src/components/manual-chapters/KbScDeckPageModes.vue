<template>
	<section id="m-kbsc-deck-page-modes">
		...
		<p>While on a <a href="#m-deck-pages">deck page</a>, you can switch between <a href="#m-deck-page-modes">deck page modes</a> by pressing one of the following keys:</p>
