<template functional>
	<section id="m-scryfall-button" key="scryfall-button">
		...
		<p>When you find a good card for your deck from Scryfall, you can then return to MTG Deck Builder and enter that card’s name in the <a href="#m-card-adder">card adder</a>.</p>
	</section>
</template>
