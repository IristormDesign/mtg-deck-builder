<template functional>
	<section id="scryfall-button" key="scryfall-button">
		...
		<p>The enormous number of distinct cards that exist in all of <i>Magic: The Gathering</i> is overwhelming. So, how can you reasonably know which ones to consider for your deck? A helpful tool for this is <a href="https://scryfall.com/advanced" target="_blank">Scryfall’s advanced card search</a>, where you can browse through a filtered list of <i>Magic</i> cards matching only the combination of attributes you specify.</p>
