<template functional>
	<section id="m-scryfall-button" key="scryfall-button">
		...
		<p>Although MTG Deck Builder has been designed to be used alongside searches on Scryfall, it’s not required. You can use any search engine for <i>Magic</i> cards, such as <a href="https://gatherer.wizards.com/" target="_blank">Gatherer</a> by Wizards of Coast instead.</p>
		<p>Whenever you find a good card for your deck from your search, you can then return to MTG Deck Builder and enter that card’s name in the <a href="#m-card-adder">card adder</a>.</p>
	</section>
</template>
