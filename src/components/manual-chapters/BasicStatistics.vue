<template>
	<section id="m-basic-statistics">
		...
		<p>These basic statistics are only a small portion of all the statistics provided by MTG Deck Builder. For deeper analysis of your deck, see the “<a href="#m-more-stats">More Statistics</a>” deck page mode.</p>
	</section>
</template>
