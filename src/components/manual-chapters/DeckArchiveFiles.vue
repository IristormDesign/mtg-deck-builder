<template functional>
	<section id="deck-archive-files" key="deck-archive-files">
		...
		<ul>
			<li>
				<p>Send the file to other users of MTG Deck Builder to let them see the decks you’ve made, or vice versa.</p>
			</li>
			<li>
				<p>Keep the file as a backup copy of all your decks in case you somehow lose access to your original deck data in your computer or phone.</p>
			</li>
			<li>
				<p>Migrate all your decks from one web browser to another (if you’re switching your preferred browser, for example).</p>
			</li>
			<li>
				<p>If you’d ever empty your web browser’s data cache, then all of your decks in MTG Deck Builder, whose data is stored in the cache, will be gone. Preserve your decks by having them as copies in a deck archive file.</p>
			</li>
		</ul>
