<template functional>
	<section id="deck-data-files" key="deck-data-files">
		...
		<ul>
			...
			<li>
				<p>Keep the file as a backup copy of your decks, in case you somehow lose access to your original deck data in your computer or mobile device.</p>
			</li>
			<li>
				<p>Move your decks from one web browser to another (if you’re switching your preferred browser, for example).</p>
			</li>
			<li>
