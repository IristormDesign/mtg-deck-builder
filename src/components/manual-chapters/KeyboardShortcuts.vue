<template>
	<section id="m-keyboard-shortcuts">
		...
		<p>If you’re using MTG Deck Builder on a computer with a physical keyboard (instead of on a mobile device), then you have the ability to use keyboard shortcuts, by which you can press designated keys to perform tasks in the app. You might find keyboard shortcuts convenient because they let you interact with elements on the page faster than by a mouse or trackpad alone.</p>
