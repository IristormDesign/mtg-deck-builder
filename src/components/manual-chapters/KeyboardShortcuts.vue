<template>
	<section id="m-keyboard-shortcuts">
		...
		<p>If you’re using MTG Deck Builder on a computer with a physical keyboard (instead of on a mobile device), then you have the option to use keyboard shortcuts, by which you press designated keys to perform tasks in the app. You might find keyboard shortcuts convenient because they let you navigate and interact with elements on the page faster than by a mouse, trackpad, or touchscreen alone.</p>
		<p>Special keyboard shortcuts are available for switching <a href="#m-kbsc-deck-page-modes">deck page modes</a> and for doing various actions in the <a href="#m-kbsc-deck-editor">Deck Editor</a> and <a href="#m-kbsc-draw-sim">Draw Simulator</a>. (There are no special shortcuts for the Deck Analyzer.)</p>
