<template>
	<section id="m-keyboard-shortcuts">
		...
		<p>Special keyboard shortcuts are available for <a href="#m-kbsc-deck-page-modes">switching deck page modes</a> and for doing various actions within the <a href="#m-kbsc-deck-editor">Deck Editor</a> and the <a href="#m-kbsc-draw-sim">Draw Simulator</a>. (No special shortcuts are available for the Deck Analyzer.)</p>
