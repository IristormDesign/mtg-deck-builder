<template>
	<section id="keyboard-shortcuts">
		...
		<p>Special keyboard shortcuts are available for <a href="#kbsc-deck-page-modes">switching deck page modes</a> and for doing various actions each within the <a href="#kbsc-deck-editor">Deck Editor</a>, <a href="#kbsc-deck-analyzer">Deck Analyzer</a>, and <a href="#kbsc-draw-sim">Draw Simulator</a>.</p>
