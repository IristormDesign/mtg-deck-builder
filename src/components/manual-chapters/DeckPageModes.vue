<template>
	<section id="m-deck-page-modes">
		...
		<p>A mode’s contents appears below the <a href="#m-deck-page-header">deck page’s header</a>. Whenever you arrive on any deck page, the mode displayed first is the Deck Editor. Switch from one mode to another by using the <a href="#m-mode-menu">mode menu</a> or a <a href="#m-kbsc-deck-page-modes">keyboard shortcut</a>.</p>
	</section>
</template>
