<template functional>
	<section id="create-deck" key="create-deck">
		...
		<p>The Create Deck page is where you <a href="#start-new-deck">begin new <i>Magic</i> decks</a> and <a href="#replicate-archived-decks">remake archived ones</a>. Whenever you create a deck by either method, the app <a href="#storage-of-deck-data">preserves the deck’s data</a> in your web browser and adds the deck to the <a href="#deck-menu">deck menu</a>.</p>
