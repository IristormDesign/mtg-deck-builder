<template>
	<section id="m-card-buttons">
		...
		<p>For a card that’s double-faced or split, its button displays the characteristics of both faces with “&nbsp;//&nbsp;” (two slashes) inserted in between each.</p>
		<p>Click any card button to <a href="#m-card-image">view that card’s image</a>.</p>
