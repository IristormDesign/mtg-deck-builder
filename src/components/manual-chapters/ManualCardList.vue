<template>
	<section id="m-card-list">
		<h4>Card List</h4>
		<p>The card list shows a column of the <i>Magic</i> cards belonging to the currently <a href="#m-group-switch">selected card group</a> of your currently <a href="#m-deck-menu">open deck</a>.</p>
		<p>Each card in the list has three interactive elements: a <a href="#m-card-buttons">button</a>, a <a href="#m-card-quantities">quantity</a>, and a <a href="#m-card-stars">star</a>. These elements will be explained in more detail.</p>
