<template>
	<section id="m-deck-name">
		...
		<h4>Deck Name</h4>
		<p>The deck name section shows the name of your currently <a href="#m-decks-menu">open deck</a>. The name itself is a link that you can click on to rename the deck.</p>
	</section>
</template>
