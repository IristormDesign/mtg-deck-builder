<template>
	<section id="m-create-deck">
		...
		<p>Every deck you have in the app must have a unique name. When you’re starting a new deck, if you happen to submit a name that another one of your decks already has, then you’ll be asked to give a different name instead. Or, if you import a deck with the same name as an existing deck, then the imported deck will be automatically renamed as if it were a <a href="#m-deck-actions">copy</a>.</p>
	</section>
</template>
