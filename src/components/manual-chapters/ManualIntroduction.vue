<template>
	<section id="m-intro">
		...
		<p>The manual is divided into many chapters. You can skip directly to a chapter you want to read by clicking the relevant link in the table of contents or on certain other links throughout the manual.</p>
