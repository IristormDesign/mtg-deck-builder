<template functional>
	<section id="card-stars" key="card-stars">
		<h5>Card Stars</h5>
		<p>MTG Deck Builder provides you the option to “star” card names—that is, you can attach a label of a “★” (star symbol) to any names you choose in the <a href="#card-list">card list</a>. A card name’s star label appears directly to the left of the <a href="#card-bars">card bar</a>.</p>
