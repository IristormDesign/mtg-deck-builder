<template>
	<section id="m-card-stars">
		...
		<p>To star a card name, click the blank space just to the left side of the card button. To un-star a name, click the star label. Alternatively, press the <kbd>A</kbd> key to star and un-star the name in the card list row that’s highlighted via <a href="#m-keyboard-shortcuts">keyboard shortcuts</a>.</p>
