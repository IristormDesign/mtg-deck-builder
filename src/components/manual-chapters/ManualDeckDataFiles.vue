<template>
	<section id="m-deck-data-files">
		...
		<ul>
			...
			<li>Keep the file as a backup copy of your deck’s data, in case your computer/device or web browser somehow causes you to lose your original deck data from the app.</li>
