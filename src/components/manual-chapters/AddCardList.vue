<template functional>
	<section id="add-card-list" key="add-card-list">
		...
		<section id="card-list-entry">
			...
			<p>The Card List Entry page provides instructions on how to write card lists as text in the correct format. (This format is the same as card lists generated by the <a href="#convert-to-text-action">Convert to Text</a> deck action.) The list you enter must follow that format, or else your list will probably be rejected or cause errors in trying to add cards.</p>
