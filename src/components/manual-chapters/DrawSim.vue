	...
	<section id="m-draw-sim">
		...
		<ol>
			...
			<li>
				...
				<p>A gap in the list will always appear between the seventh and eighth drawn cards. This gap visually separates what represents your starting hand (usually seven cards, according to <a href="#m-game-rules"><i>Magic</i>’s rules</a>) and the rest of your deck.</p>
			</li>
			<li>
