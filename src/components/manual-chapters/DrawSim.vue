	...
	<section id="m-draw-sim">
		...
		<ul>
			...
			<li>
				...
				<p>A gap appears in the card list between the seventh and eighth drawn cards. This gap separates what represents your starting hand (normally seven cards according to <a href="#m-game-rules"><i>Magic</i>’s rules</a>) and the rest of your deck.</p>
			</li>
			<li>
