<template>
	<section id="m-draw-sim">
		...
		<ul>
			...
			<li>
				<p><strong>Card list section</strong> – This shows the record of cards you’ve drawn in chronological order during the current round. The list features <a href="#m-card-stars">card stars</a> and <a href="#m-card-buttons">card buttons</a> that work like those same elements in the Deck Editor.</p>
				<p>Unlike the Deck Editor, however, card quantities are absent in the Draw Simulator. This is because each item of the Draw Simulator’s card list represents a singular, individual card rather than a card name. The Draw Simulator’s list could repeat a card name if your deck has multiples of it.</p>
				<p>A gap will appear in the list between the seventh and eighth drawn cards. This gap visually separates what represents your starting hand (normally seven cards according to <a href="#m-game-rules"><i>Magic</i>’s rules</a>) and the rest of your deck.</p>
			</li>
			<li>
