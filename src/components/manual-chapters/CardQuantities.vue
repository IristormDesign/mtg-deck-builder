<template functional>
	<section id="m-card-quantities" key="card-quantities">
		...
		<ul>
			...
			<li>
				<p>With the card list row highlighted via <a href="#m-keyboard-shortcuts">keyboard shortcuts</a>, press <kbd>E</kbd> to increase the quantity, or <kbd>D</kbd> to decrease it. Or, while holding <kbd class="shift-key">Shift</kbd>, press <kbd>E</kbd> or <kbd>D</kbd> to adjust the quantity by 2 instead of 1.</p>
			</li>
		</ul>
