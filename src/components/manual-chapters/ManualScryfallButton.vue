<template>
	<section id="m-scryfall-button">
		...
		<p>On <a href="#m-deck-pages">deck pages</a> in MTG Deck Builder, there’s a button labeled with the Scryfall logo. You can click on that button to be taken directly to Scryfall’s advanced search page, which opens in a new browser tab.</p>
