<template>
	<section id="m-card-quantities">
		...
		<ul>
			...
			<li>If you’re on a large-screen device, hover your mouse pointer over the quantity number to make a pair of buttons appear beside it. Of that pair of buttons, click on the “+” (plus sign) button to increase the quantity, or the “&minus;” (minus sign) to decrease.</li>
			<li>Click on the quantity number to make your web browser focus on it. Then press the up-arrow key on your keyboard to increase the quantity, or the down-arrow key to decrease.</li>
		</ul>
