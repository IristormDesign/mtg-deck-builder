<template>
	<section id="m-card-quantities">
		...
		<p>To the right of each card button in the <a href="#m-card-list">card list</a> is a number representing the quantity (“QTY.”) of the card.</p>
		...
		<ul>
			...
			<li>If you’re on a large-screen device, hover your mouse pointer over the quantity number to make a pair of buttons appear beside it. Of that pair of buttons, click on the “+” (plus sign) to increase the card’s quantity, or the “&minus;” (minus sign) to decrease.</li>
			<li>Click on the quantity number to make your web browser focus on it, and then press the up-arrow key on your keyboard to increase, or the down-arrow key to decrease.</li>
		</ul>
