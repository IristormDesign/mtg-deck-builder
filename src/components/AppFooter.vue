<template>
	<footer class="app-footer">
		<div class="wrap">
			<p>
				<span class="group">
					<router-link to="/"><strong>MTG Deck Builder</strong></router-link> by <a href="https://iristormdesign.com" target="_blank" rel="noopener">Iristorm Design</a> — <span>Version 1.13.4</span>
				</span>
				<span class="group">
