<template>
	<section id="m-intro">
		...
		<p>The manual has screenshots that show parts of MTG Deck Builder. Note that some screenshots show the app in an older version, which may look slightly different from the current version.</p>
