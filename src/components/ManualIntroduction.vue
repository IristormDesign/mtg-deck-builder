<template>
	<section id="m-intro">
		<figure>
			...
			<small>(Illustration: <i><a href="https://scryfall.com/card/dom/235/urzas-tome" target="_blank">Urza’s Tome</a></i> by Aaron Miller)</small>
		</figure>
		...
		<p>The manual displays screenshots of parts of MTG Deck Builder. Note that some of these screenshots show the app in an older version, which may look slightly different from the current version.</p>
		<p>MTG Deck Builder assumes you know how to play <i>Magic: The Gathering</i>. If you have an issue about the rules of the game, you can refer to them on the <a href="https://magic.wizards.com/en/rules" target="_blank">official <i>Magic</i> website</a> or the <a href="https://mtg.fandom.com/wiki/Comprehensive_Rules" target="_blank">Fandom MTG Wiki</a>.</p>
