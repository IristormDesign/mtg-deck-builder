<template>
	<section id="m-deck-actions">
		...
		<ul>
			<li><strong>Copy</strong> – Creates a new deck with an identical list of cards as the active deck at the time of copying. The deck copy’s name is the same as the origin deck’s, except that a unique number within parentheses is appended to it. (You can always <a href="#m-deck-name">rename</a> the deck later.)</li>
		...
		<p>Whenever you select any deck action option, the app asks you to confirm the action before proceeding, allowing you to cancel it.</p>
	</section>
</template>
