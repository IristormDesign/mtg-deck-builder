<template>
	<section id="m-card-list">
		...
		<p>This section shows the list of <i>Magic</i> cards belonging to the currently <a href="#m-group-toggler">selected card group</a> of your currently open deck.</p>
