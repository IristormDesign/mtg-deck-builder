		...
		<div class="layout-column">
			...
			<section class="card-list-section">
				...
				>
					...
					<footer class="notes">
						<p>To begin, click the Draw a Card button. Click it while holding <kbd class="shift-key">Shift</kbd> to draw 10 at once. For more info, see the <router-link to="/guide/draw-sim">User Guide</router-link>.</p>
					</footer>
				</div>
				<div
					v-else
