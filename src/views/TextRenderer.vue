<template>
	...
	>
		<template v-if="mainNotEmpty || sideboardNotEmpty">
			<header class="intro">
				<p>The Text Renderer provides the card lists of <i>{{ deck.name }}</i> in simplified text versions, which let you easily take copies of them outside MTG Deck Builder. <router-link to="/guide/text-renderer">(More info&hellip;)</router-link></p>
			</header>
