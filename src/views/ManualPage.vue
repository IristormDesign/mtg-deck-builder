		...
		<div class="the-manual">
			...
			<section id="m-deck-pages">
				...
				<section id="m-deck-actions">
					...
					<ul>
						<li><strong>Copy</strong> — Creates a new deck with an identical list of cards as the current deck at the time of copying. The deck copy’s name will be the same as the origin deck’s, except that a unique number within parentheses is appended to it. (You can always <a href="#m-deck-name">rename</a> the deck later.)</li>
