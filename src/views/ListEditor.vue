...
import DialogsListEditor from '@/components/deck-page/DialogsListEditor.vue'
import cardListFunctions from '@/mixins/cardListFunctions'

export default {
	components: { CardImage, CardSorter, CardGroupSwitch, SideboardHeader, CardListItems, ScryfallButton, ListEntryButton, CardAdder, DialogsListEditor },
