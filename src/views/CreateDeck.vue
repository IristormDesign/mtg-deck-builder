<template>
	<article class="create-deck-page content-box">
		...
		<div class="intro">
			...
			<p>Create a deck in two ways: Either start from a new, empty deck page and add cards to it, or replicate the decks from a deck archive file. <router-link to="/manual/#create-deck">(More info&hellip;)</router-link></p>
		</div>
		<div class="columns">
			<div class="new-deck">
				<h3>New Deck</h3>
