<template functional>
	<article class="contact-page content-box">
		...
		<p>The creator of MTG Deck Builder is Damian Schmidt of <a href="https://iristormdesign.com/" target="_blank">Iristorm Design<svg><use href="#open-in-new-icon" /></svg></a>. You can contact him for questions or comments via any of the following media. Bug reports are appreciated.</p>
		...
		<figure>
			...
			<figcaption>Illustration from <i><a href="https://scryfall.com/card/c18/108/tidings" target="_blank">Tidings<svg><use href="#open-in-new-icon" /></svg></a></i> by Pete Venters</figcaption>
		</figure>

		<div class="column">
			<h3>Email</h3>
			<p>Send an email to <a href="mailto:damian@iristormdesign.com">damian@iristormdesign.com<svg><use href="#open-in-new-icon" /></svg></a>.</p>
