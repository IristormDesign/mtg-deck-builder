<template functional>
	<article class="contact-page content-box">
		...
		<figure>
			<img class="intro-illustration" src="~@/img/tidings.jpg" width="626" height="457" alt="An illustration of a man's hand pressing a wax seal onto a scroll by candlelight" />
		...
		<div class="column">
			...
			<ul>
				...
				<li>
					<p><strong>GitHub</strong> – Though MTG Deck Builder is copyrighted, you can see its <a href="https://github.com/IristormDesign/mtg-deck-builder" target="_blank">source code on GitHub</a>. You can contact the developer (@IristormDesign) on there, too.</p>
				</li>
				<li>
