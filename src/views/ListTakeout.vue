<template>
	...
	>
		<template v-if="mainNotEmpty || sideboardNotEmpty">
			<header class="intro">
				<p>List Takeout provides copies of the card lists of <i>{{ deck.name }}</i> in simplified text versions. They may have uses to you outside MTG Deck Builder. <router-link to="/guide/list-takeout">(More info&hellip;)</router-link></p>
			</header>
