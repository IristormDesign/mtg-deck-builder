<template functional>
	<section id="create-deck" key="create-deck">
		...
		<section id="start-new-deck">
			...
			<p>To start a new deck, go to the <a href="#create-deck">Create Deck page</a>. In the “New Deck” section, enter a name for your deck in the text input field.</p>
			<p>Naming a deck has the following requirements:</p>
			<ul>
			...
			<p>Assemble your new deck in the <router-link to="list-editor">List Editor mode</router-link> using the <router-link to="list-editor#card-adder">card adder tool</router-link> or the <router-link to="card-list-entry">card list entry form</router-link>. For ideas of cards you could include, you can browse through an <router-link to="list-editor#scryfall-button">advanced search</router-link> on Scryfall.</p>
		</section>
