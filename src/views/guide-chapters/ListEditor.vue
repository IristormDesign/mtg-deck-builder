<template functional>
	<section id="list-editor" key="list-editor">
		...
		<section id="scryfall-button">
			...
			<p>The number of distinct cards that exist in all of <i>Magic: The Gathering</i> is overwhelmingly huge. So, how can you reasonably figure which ones to consider for your deck? A helpful solution to this is <a href="https://scryfall.com/advanced" target="_blank">Scryfall’s advanced card search</a>, where you can browse through a filtered list of <i>Magic</i> cards matching only the combination of attributes you specify.</p>
			...
			<p>Though MTG Deck Builder has been designed to be used alongside searches on Scryfall, you don’t have to use Scryfall. There are alternative search engines for <i>Magic</i> cards, such as <a href="https://gatherer.wizards.com/" target="_blank">Gatherer</a>, and the search features on many online stores that sell <i>Magic</i> card singles.</p>
