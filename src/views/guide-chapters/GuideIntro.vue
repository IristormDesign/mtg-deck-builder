<template functional>
	<section id="guide-intro" key="guide-intro">
		...
		<p>This user guide consists of many chapters. You can skip directly to a chapter you want to read by clicking the relevant link in the table of contents, or by clicking any chapter links throughout the guide’s text.</p>
